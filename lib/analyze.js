    ...
    contents: [
      {
        ...
        parts: [
          {
            text: "Analise esta imagem de remedio, identifique o medicamento com cautela e responda apenas com JSON estruturado conforme o schema. Priorize seguranca, indique o nivel de confianca e nao invente dados."
          },
          {
            inline_data: {
              mime_type: mimeType,
